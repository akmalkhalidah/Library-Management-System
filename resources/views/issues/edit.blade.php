...
@section('content')
  ...
  <input class="form-control datepicker @error('issue_date') is-invalid @enderror" data-date-format="dd/mm/yyyy" name="issue_date" value="{{ old('issue_date', $issue->issue_date) }}" readonly>
  <div class="input-group-prepend">
                 ...
                 <strong>{{ $message }}</strong>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control datepicker @error('due_date') is-invalid @enderror" data-date-format="dd/mm/yyyy" name="due_date" value="{{ old('publish_date', $issue->due_date) }}" readonly>
                                        <div class="input-group-prepend">
                                            <div class="input-group-text">
                                                <i class="icon-regular i-Calendar-4"></i>
                                            </div>
